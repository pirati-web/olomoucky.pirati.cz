...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_development_dependency(%q<rake>.freeze, ["< 99", ">= 1"])
      ...
      s.add_development_dependency(%q<pry>.freeze, ["< 0.99", ">= 0.1"])
      s.add_runtime_dependency(%q<jekyll>.freeze, ["< 5.0", ">= 3.1"])
      s.add_runtime_dependency(%q<pathutil>.freeze, ["~> 0.16"])
    else
      s.add_dependency(%q<rake>.freeze, ["< 99", ">= 1"])
      ...
      s.add_dependency(%q<pry>.freeze, ["< 0.99", ">= 0.1"])
      s.add_dependency(%q<jekyll>.freeze, ["< 5.0", ">= 3.1"])
